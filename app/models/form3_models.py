"""
Modelos Pydantic para el Formulario 3 - Evaluación Preescolar Integrales v3
Basado en el diccionario de ejemplo de form3.py
"""
...
class Pagina2Form3(BaseModel):
    """Datos de la página 2 del formulario 3"""
    ...
    coordinador_zona: List[int] = Field(..., description="4 valores de 1-10 para coordinador de zona")
...
class Form3Request(BaseModel):
    """Modelo completo para el formulario 3"""
    ...
    pagina_2: Pagina2Form3 = Field(..., description="Datos de la página 2 del formulario")
