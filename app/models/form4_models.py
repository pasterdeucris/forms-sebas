"""
Modelos Pydantic para el Formulario 4 - Evaluación Preescolar Integrales v4
Basado en el diccionario de ejemplo de form4.py
"""
...
class Pagina2Form4(BaseModel):
    """Datos de la página 2 del formulario 4"""
    proceso_aprendizaje: List[int] = Field(..., description="4 valores de 1-10 para proceso de aprendizaje de los niños")
    acompanamiento_familia: List[int] = Field(..., description="5 valores de 1-10 para acompañamiento a la familia")
    ...
    coordinador_pedagogico: List[int] = Field(..., description="4 valores de 1-10 para coordinador pedagógico")
...
class Form4Request(BaseModel):
    """Modelo completo para el formulario 4"""
    ...
    pagina_2: Pagina2Form4 = Field(..., description="Datos de la página 2 del formulario")
